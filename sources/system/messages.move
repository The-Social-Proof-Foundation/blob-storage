...
module blob_storage::messages {

use mys::{bcs::{Self, BCS}, bls12381::bls12381_min_pk_verify};
...
/// Creates a new ProofOfPossessionMessage given the expected epoch, mys address and BLS key.
...
public(package) fun to_bcs(self: &ProofOfPossessionMessage): vector<u8> {
    ...
    bcs.append(bcs::to_bytes(&self.mys_address));
