...
module blob_storage::storage_resource {
...
/// Necessary to allow `blob_storage::system` to create storage objects.
/// Cannot be called outside of the current module and [blob_storage::system].
